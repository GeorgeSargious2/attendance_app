import 'package:attendance_app/modules/admin_screens/admin_layout/admin_layout.dart';
...
import '../../member_screens/login_screen/forgotten_password_screen.dart';
import '../../member_screens/login_screen/login_cubit/Login States.dart';
import '../admin_register_screen/admin_register_screen.dart';
import 'admin_login_cubit/admin_login_cubit.dart';
...
class AdminLoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<adminLoginCubit, loginStates>(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                            ...
                            hintText: 'Password',
                            obscureText:
                                adminLoginCubit.get(context).isPassShow,
                            suffixIcon: IconButton(
                                icon: Icon(adminLoginCubit.get(context).suffix),
                                onPressed: () {
                                  adminLoginCubit.get(context).passShow();
                                }),
                          ...
                          builder: (context) => CustomButton(
                              ...
                              onPressed: () async {
                                if (formkey.currentState!.validate()) {
                                  adminLoginCubit.get(context).userLogin(
