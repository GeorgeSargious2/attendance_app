...
import 'package:attendance_app/modules/member_screens/register_screen/Register_Cubit/Register_States.dart';
...
import 'admin_register_cubit/admin_register_Cubit.dart';
...
class AdminRegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => adminRegisterCubit(),
      child: BlocConsumer<adminRegisterCubit, registerStates>(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      verticalSpace(10),
                      Text('Register now to became an admin',
                      ...
                      CustomTextFormField(
                        ...
                        hintText: 'password',
                        obscureText: adminRegisterCubit.get(context).isPassShow,
                        suffixIcon: IconButton(
                            icon: Icon(
                                adminRegisterCubit.get(context).passSuffix),
                            onPressed: () {
                              adminRegisterCubit.get(context).passShow();
                            }),
                      ...
                      CustomTextFormField(
                        ...
                        obscureText:
                            adminRegisterCubit.get(context).isConfirmPassShow,
                        suffixIcon: IconButton(
                            icon: Icon(adminRegisterCubit
                                .get(context)
                                .confirmPassSuffix),
                            onPressed: () {
                              adminRegisterCubit.get(context).confirmPassShow();
                            }),
                        keyboardType: TextInputType.visiblePassword,
                        ...
                        builder: (context) => CustomButton(
                            ...
                            onPressed: () {
                              if (formKey.currentState!.validate()) {
                                if (adminRegisterCubit.get(context).imageFile !=
                                    null) {
                                  adminRegisterCubit.get(context).userRegister(
  ...
  return Row(
    children: [
      ...
      CircleAvatar(
        ...
        backgroundImage: adminRegisterCubit.get(context).imageFile == null
            ? null
            : FileImage(
                File(adminRegisterCubit.get(context).imageFile!.path),
              ),
      ),
      horizontalSpace(20),
      Column(
        children: [
          Container(
            ...
            child: IconButton(
              onPressed: () {
                adminRegisterCubit.get(context).pickImageCamera();
              },
              icon: Icon(
                Icons.camera_alt,
          ...
          Container(
            ...
            child: IconButton(
              onPressed: () {
                adminRegisterCubit.get(context).pickImageGallery();
              },
              icon: const Icon(
                Icons.photo,
                color: ColorsManager.white,
